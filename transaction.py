...
class Transaction:
    ...
    def _get_market_cap_price(self) -> dict:
        mcap_price = {}
        mcap_price["mcap_usdc"] = (
            self.totx_digg_price["digg_usdc_price"] * self.totx_digg_supply
        )
        mcap_price["mcap_wbtc"] = (
            self.totx_digg_price["digg_wbtc_price"] * self.totx_digg_supply
        )
